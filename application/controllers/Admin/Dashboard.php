...
class Dashboard extends CI_Controller
{
  ...
  public function Pedagang($status = null)
  {
    $data['pedagang'] = $this->Modelpedagang->get_all($status);
    $this->load->view('template_admin/header');
    $this->load->view('template_admin/sidebar');
    $this->load->view('admin/v_pedagang',$data);
  ...
  {
    if ($this->input->post()) {
      $this->Modelpedagang->addpedagang();
      $this->session->set_flashdata(['alert'=>'Data berhasil di masukan']);
      redirect('Admin/Dashboard/Pedagang');
    }else{
      $this->load->view('template_admin/header');
      $this->load->view('template_admin/sidebar');
      $this->load->view('Admin/v_add_pedagang');
      $this->load->view('template_admin/footer');
