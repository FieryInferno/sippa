<main id='main'>
  <div class="container">
  <div class="card">
    <form action="<?php base_url('admin/petugas/edit/' . $id) ?>" method="post" enctype="multipart/form-data">
      <div class="card-body">
        <div class="form-group col-6">
          <label for="">Nama Petugas</label>
          <input type="text" class="form-control" name="nama" id="nama" aria-describedby="helpId" placeholder="" value="<?= $nama; ?>">
        </div>
        <div class="form-group col-6">
        ...
        <div class="form-group col-6">
          ...
          <input type="text" class="form-control" name="username" id="username" aria-describedby="helpId" placeholder="" value="<?= $username; ?>">
        </div>
        <div class="form-group col-6">
