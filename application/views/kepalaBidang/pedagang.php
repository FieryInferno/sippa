    ...
    <div class="card mb-3">
      <div class="card-header">
        <div class="row">
          ...
          <div class="col-12">
            <a href="<?= base_url(); ?>kepala_bidang/data_pedagang" class="btn btn-primary">Seluruh Pedagang</a>
            <a href="<?= base_url(); ?>kepala_bidang/data_pedagang/buka" class="btn btn-primary">Pedagang Buka</a>
            <a href="<?= base_url(); ?>kepala_bidang/data_pedagang/tutup" class="btn btn-primary">Pedagang Tutup</a>
          </div>
        </div>
      </div>
      <div class="card-body">
