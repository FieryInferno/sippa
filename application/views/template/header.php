...
<head>
  ...
  <title>Sistem Informasi Pengelolaan Pasar</title>
  ...
  <link rel="stylesheet" href="<?= base_url(); ?>assets/css/animation/animation-custom.css">
  <!-- normalize CSS
  ============================================ -->
  ...
  <!--  animation JS
  ============================================ -->
  <script src="<?= base_url(); ?>assets/js/animation/animation-active.js"></script>
  <!--  Chat JS
  ============================================ -->
      ...
      <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
          <div class="row">
            <div class="col-lg-2">
              <div class="logo-area">
                <a href="<?= base_url(); ?>"><img src="<?= base_url('assets/'); ?>img/logo.png" alt="" width="75px"/></a> 
              </div>
            </div>
            <div class="col-lg-10" style="margin-top: 20px;">
              <h1>Sistem Informasi Pengelolaan Pasar</h1>
            </div>
          </div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            ...
            <ul class="nav navbar-nav notika-top-nav">
              <?php
                if ($this->session->masuk) { ?>
                  <li class="nav-item">
                    <a href="<?= base_url(); ?>PedagangBaru/Chat" class="btn btn-warning btn-sm" style="padding-left: 10px;margin-top: 30px;padding-bottom: 10px; padding-top: 10px;padding-right: 10px;background-color: #eec107; border-color: #eec107;margin-right:10px;">
                      <span>Chat</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="<?= base_url(); ?>Login/logout" class="btn btn-warning btn-sm" style="padding-left: 10px;margin-top: 30px;padding-bottom: 10px; padding-top: 10px;padding-right: 10px;background-color: #eec107; border-color: #eec107;">
                      <span>Logout</span>
                    </a>
                  </li>
                <?php } else { ?>
                  <li class="nav-item">
                    <a href="<?= base_url(); ?>Login" class="btn btn-warning btn-sm" style="padding-left: 10px;margin-top: 30px;padding-bottom: 10px; padding-top: 10px;padding-right: 10px;background-color: #eec107; border-color: #eec107;margin-right:10px;">
                      <span>Login</span>
                    </a>
                  </li>
                  <li class="nav-item">
                    <a href="<?= base_url(); ?>Daftar" class="btn btn-warning btn-sm" style="padding-left: 10px;margin-top: 30px;padding-bottom: 10px; padding-top: 10px;padding-right: 10px;background-color: #eec107; border-color: #eec107;">
                      <span>Daftar</span>
                    </a>
                  </li>
                <?php }
